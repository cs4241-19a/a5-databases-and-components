    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file, 103, 8, 4097);
    			...
    			add_location(button0, file, 101, 4, 3878);
    			attr_dev(span1, "class", "sr-only");
    			add_location(span1, file, 109, 50, 4356);
    			attr_dev(a0, "class", "nav-link");
    			attr_dev(a0, "href", "#");
    			add_location(a0, file, 109, 16, 4322);
    			attr_dev(li0, "class", "nav-item active");
    			add_location(li0, file, 108, 12, 4277);
    			...
    			add_location(input1, file, 145, 16, 5808);
    			attr_dev(div3, "class", "form-group");
    			add_location(div3, file, 143, 12, 5695);
    			attr_dev(label1, "for", "inputDate");
    			add_location(label1, file, 149, 16, 6009);
    			...
    			add_location(input2, file, 150, 16, 6061);
    			attr_dev(div4, "class", "form-group");
    			add_location(div4, file, 148, 12, 5968);
    			attr_dev(div5, "class", "w-100");
    			add_location(div5, file, 152, 12, 6192);
    			attr_dev(button2, "id", "add");
    			attr_dev(button2, "class", "btn btn-primary col-6");
    			add_location(button2, file, 153, 12, 6230);
    			attr_dev(div6, "class", "row justify-content-around");
    			add_location(div6, file, 142, 8, 5642);
    			attr_dev(form1, "action", "");
    			add_location(form1, file, 141, 4, 5617);
    			attr_dev(div7, "class", "container mt-3");
    			add_location(div7, file, 140, 0, 5584);
    			attr_dev(ul1, "class", "list-group mt-3");
    			attr_dev(ul1, "id", "notesContainer");
    			add_location(ul1, file, 158, 4, 6373);
    			attr_dev(div8, "class", "container");
    			add_location(div8, file, 157, 0, 6345);
