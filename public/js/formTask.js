...
const add = function (e) {
  ...
  const json = { name: n, Board: b, taskName: task.value, taskDes: taskDesc.value, dueDate: due.value, taskNum: taskno.toString() }
  const body = JSON.stringify(json)
...
const editTask = function (e) {
  ...
  const json = { name: n, Board: b, taskNum: taskN.value, taskName: taskNam.value, taskDes: taskDe.value, dueDate: taskDu.value, diff: 'yes' }
  const body = JSON.stringify(json)
